...
if(NOT "include" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'map2image' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/lars/OculusCamViewer_new/install/${idir}'.  Ask the maintainer 'Lars Harmsen <lars.harmsen@outlook.com>' to fix it.")
    endif()
