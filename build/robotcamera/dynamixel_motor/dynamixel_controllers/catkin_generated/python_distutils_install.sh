...
cd "/home/lars/OculusCamViewer_new/src/robotcamera/dynamixel_motor/dynamixel_controllers"
...
/usr/bin/env \
    ...
    build --build-base "/home/lars/OculusCamViewer_new/build/robotcamera/dynamixel_motor/dynamixel_controllers" \
    install \
    $DESTDIR_ARG \
