...
if("FALSE" STREQUAL "TRUE")
  set(rosaria_SOURCE_PREFIX /home/lars/OculusCamViewer_new/src/robotcamera/rosaria)
  set(rosaria_DEVEL_PREFIX /home/lars/OculusCamViewer_new/devel)
  set(rosaria_INSTALL_PREFIX "")
  set(rosaria_PREFIX ${rosaria_DEVEL_PREFIX})
else()
  set(rosaria_SOURCE_PREFIX "")
  set(rosaria_DEVEL_PREFIX "")
  set(rosaria_INSTALL_PREFIX /home/lars/OculusCamViewer_new/install)
...
if(NOT "include" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'rosaria' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/lars/OculusCamViewer_new/install/${idir}'.  Ask the maintainer 'Srećko Jurić-Kavelj <srecko.juric-kavelj@fer.hr>, Ivan Marković <ivan.markovic@fer.hr>' to fix it.")
    endif()
